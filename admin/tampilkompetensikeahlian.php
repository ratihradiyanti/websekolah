...
$query_Recordset1 = "SELECT * FROM kompetensi_keahlian ORDER BY kompetensi_kode ASC";
$Recordset1 = mysql_query($query_Recordset1, $siswa) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

$colname_kompetensi = "-1";
if (isset($_GET['keyword'])) {
  $colname_kompetensi = $_GET['keyword'];
}
mysql_select_db($database_siswa, $siswa);
$query_kompetensi = sprintf("SELECT * FROM kompetensi_keahlian WHERE kompetensi_nama LIKE %s ORDER BY kompetensi_nama ASC", GetSQLValueString("%" . $colname_kompetensi . "%", "text"));
		...
		<div id="wrapper-bgtop">
			<div id="page">
				<div id="content">
				  <div class="post">
                    <center>
                      <h3>TAMPIL KOMPETENSI KEAHLIAN</h3>
                    </center>
				    <hr />
                    <p>&nbsp;</p>
				    <table border="1" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row_Recordset1['kompetensi_nama']; ?></td>
                        <td><a href="editkompetensikeahlian.php?kompetensi_kode=<?php echo $row_Recordset1['kompetensi_kode']; ?>">Edit</a></td>
                        <td><a href="deletekompetensikeahlian.php?kompetensi_kode=<?php echo $row_Recordset1['kompetensi_kode']; ?>">Hapus</a></td>
                      </tr>
                      <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
                    </table>
			      </div>
		          <p>&nbsp;</p>
		          <p><strong>PENCARIAN KOMPETENSI KEAHLIAN</strong></p>
		          <form id="form1" method="get" action="">
				    <p>
				      ...
				      <em>cari berdasarkan nama</em></p>
			      </form>
				  
                  <?php if ($totalRows_kompetensi > 0) { // Show if recordset not empty ?>
                  <table border="2" cellpadding="2" cellspacing="1">
                      ...
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_kompetensi['kompetensi_kode']; ?></td>
                          <td><?php echo $row_kompetensi['bidang_kode']; ?></td>
                          <td><?php echo $row_kompetensi['kompetensi_nama']; ?></td>
                        </tr>
                        <?php } while ($row_kompetensi = mysql_fetch_assoc($kompetensi)); ?>
                  </table>
